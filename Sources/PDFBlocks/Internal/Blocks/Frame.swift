...
extension Frame: Renderable {
    func sizeFor(context: Context, environment: EnvironmentValues, proposedSize: ProposedSize) -> BlockSize {
        ...
        if renderable.isSecondaryPageWrapBlock(context: context, environment: environment) {
            return renderable.sizeFor(context: context, environment: environment, proposedSize: proposedSize)
        } else {
            ...
            let size = renderable.sizeFor(context: context, environment: environment, proposedSize: adjustedSize)
    ...
    func render(context: Context, environment: EnvironmentValues, rect: CGRect) {
        ...
        if renderable.isSecondaryPageWrapBlock(context: context, environment: environment) {
            ...
            renderable.render(context: context, environment: environment, rect: printRect)
        }
    }
